...
#>
   ...
   process
   {
    ...
    Write-Host "Removing 'app' (Webapp-Openidconnect) if needed"
    $app=Get-AzureADApplication -Filter "identifierUris/any(uri:uri eq 'https://$tenantName/Webapp-Openidconnect')"  
    if ($app)
    {
